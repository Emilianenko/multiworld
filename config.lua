...
--agregado white skull attack pk yellow block -- no requeried
--pzLockSkullAttacker = true
--fightbackPz = true
...
-- Item Usage
timeBetweenActions = 200 --fishing rods etc
timeBetweenExActions = 1000 ---exhaust vial
...
-- new monster overspawn
deSpawnRange = 0 --2
deSpawnRadius = 10 --50
--removeOnDespawn = false
walkToSpawnRadius = 0--15
